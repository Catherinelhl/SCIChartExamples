...
public class HeatmapChartFragment_ViewBinding implements Unbinder {
  private HeatmapChartFragment target;

  @UiThread
  public HeatmapChartFragment_ViewBinding(HeatmapChartFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    HeatmapChartFragment target = this.target;
